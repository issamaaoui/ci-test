...
class Customweb_PayboxCw_Block_Adminhtml_BackendForm_Switcher extends Mage_Adminhtml_Block_Template
{
    protected function _prepareLayout()
    {
        $this->setTemplate('customweb/payboxcw/backendform/switcher.phtml');
