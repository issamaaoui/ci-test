...
class Customweb_PayboxCw_Model_Transaction_Api extends Mage_Api_Model_Resource_Abstract
{
    ...
    protected function prepareEntry(Customweb_PayboxCw_Model_Transaction $transaction, $attributes = null)
    {
