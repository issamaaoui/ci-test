 ...
 * @Bean
 */
class Customweb_PayboxCw_Model_UpdateHandler implements Customweb_Payment_Update_IHandler
{
	public function getContainer() {
		return Mage::helper('PayboxCw')->createContainer();
	}
	...
	public function getScheduledTransactionIds() {
		...
		$query = 'SELECT transaction_id FROM ' . $resource->getTableName('payboxcw/transaction')
