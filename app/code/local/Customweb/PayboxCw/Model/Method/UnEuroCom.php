...
class Customweb_PayboxCw_Model_Method_UnEuroCom extends Customweb_PayboxCw_Model_Method
implements Mage_Payment_Model_Recurring_Profile_MethodInterface
{
	protected $_code = 'payboxcw_uneurocom';
	protected $paymentMethodName = 'uneurocom';
