...
class Fidesio_Preorder_Helper_PasswordEncryptorBlowfish extends Fidesio_Preorder_Helper_PasswordEncryptor {
    /**
     * Cost of encryption.
    ...
    public function encrypt($password, $salt = null, $member = null) {
        ...
        if(strpos($encryptedPassword, '$2') === false) {
            throw new Fidesio_Preorder_Helper_PasswordEncryptorEncryptionFailed('Blowfish password encryption failed.');
        }
    ...
    public function salt($password, $member = null) {
        $generator = new Fidesio_Preorder_Helper_RandomGenerator();
