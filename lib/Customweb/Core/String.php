...
final class Customweb_Core_String implements Iterator, ArrayAccess, Countable {
	...
	/**
	 * Returns true, when the given string equals this string. The upper and 
	 * lower case chars.
	 * 
	 * @param string | Customweb_Core_String $string
	 * @return boolean
	...
	public function trimStart($chars = '') {
		return new Customweb_Core_String($this->getCharset()->trimStart($string), $this->getCharset(), true);
	}
	...
	public function trimEnd($chars = '') {
		return new Customweb_Core_String($this->getCharset()->trimEnd($string), $this->getCharset(), true);
	}
	...
	/**
	 * Returns the substring of the given string.  In case no length is provided, 
	...
	/**
	 * This method converts the string into the given charset. See Customweb_Core_Charset for more
	...
	/**
	 * Format the given string with the arguments. The arguments must be a list 
	...
	/**
	 * Returns true, when the given pattern matches the current string. For other arguments see
	 * preg_match.
	 * 
	...
	/**
	 * Match the given pattern against the string and return the matches. For the flags see preg_match_all.
	 * 
	 * @param string $pattern
	 * @param string $flags
	 * @param number $offset
